...
class Pages_controller_test extends TestCase
{
    ...
    public function test_When_access_index_Then_see_home_page()
    {
        $output = $this->request('GET', '/');
        $this->assertContains('This is the home page', $output);
    }

    public function test_When_access_news_Then_see_articles_table()
    {
    ...
    {
        $slug_en = 'title-en-test-1';
        $slug_es = 'title-es-test-1';
