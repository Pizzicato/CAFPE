 ...
 */
$config['site_title']                 = "CAFPE - Centro Andaluz de Física de Partículas Elementales";       // Site Title, example.com
$config['admin_email']                = "pabloguaza@ugr.es"; // Admin Email, admin@example.com
